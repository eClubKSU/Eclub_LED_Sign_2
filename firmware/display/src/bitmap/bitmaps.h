...
namespace Bitmaps {
	...
	static u32_t palette_Dino_Menu[4] = {0x000000, 0x265399, 0x990099, 0x009900};
	static u8_t data_Dino_Menu[24] = {0x40, 0xa5, 0xfe, 0x40, 0xa5, 0xfe, 0x40, 0xa5, 0xfe, 0x40, 0xa5, 0xfe, 0x40, 0xa5, 0xfe, 0x40, 0xa5, 0xfe, 0x40, 0xa5, 0xfe, 0x40, 0xa5, 0xfe};
	static GFX::Bitmap* Dino_Menu = new GFX::Bitmap{12, 8, 4, palette_Dino_Menu, data_Dino_Menu};
